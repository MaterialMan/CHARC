...
handles.output = hObject;
    ...
    H=zeros(n_size,n_size)-2;
    axes(handles.axes3);
    mesh(H);
    axis([1 n_size 1 n_size -2 6]);
    ...
    while run
        ...
        newH=Wave(n_size,i,j,0.05,0.5,1,H,oldH,0,0,0);
...
function RUN_button_Callback(hObject, eventdata, handles)
    ...
    global globH globOH Ekin Epot n_size;
    if run
        toggle(0,handles);
...
while run
    ...
    newH = Wave(n_size,i,j,dt,c,k,H,oldH,fix,cont,connect);% Wave equation
