function [Command, Exp_status]=Demo_Open_Space(Exp_status,Initialization)
% Example of open space environment
% Robots move uniformely distributed around a given circle path.
% No collision avoidance is implemented
% If Exp_status.Workspace is not defined, an open environment is assumed
